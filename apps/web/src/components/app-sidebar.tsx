import { BookOpenCheck, BookText, Building2, GitCompareArrows, Handshake, Sparkles, LayoutDashboard, ListChecks, PlugZap, Scale, ScrollText, ShieldCheck } from "lucide-react";
...
const items = [
  ...
  { key: "insights", url: "/insights", icon: Sparkles },
